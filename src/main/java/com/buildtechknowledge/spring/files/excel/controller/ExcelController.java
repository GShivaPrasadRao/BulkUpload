package com.buildtechknowledge.spring.files.excel.controller;
...
import com.buildtechknowledge.spring.files.excel.service.ExcelService;
...
public class ExcelController {
  ...
  public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file) {
    ...
    logger.info("This is a ERROR statement"+ExcelHelper.hasExcelFormat(file));
